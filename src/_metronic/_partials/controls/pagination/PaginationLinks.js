...
export function PaginationLinks({ paginationProps, metadata }) {
  ...
  const handleLastPage = ({ onPageChange }) => { onPageChange(pagesCount); };
  const handleSelectedPage = ({ onPageChange }, pageNum) => { onPageChange(pageNum);};
