...
import {productsActions, useProductsState} from "../../../../../../redux/products";
...
export const Form = ({ formik, advancedSearch }) => {
  ...
  const {metadata: {sort}} = useProductsState();
  const {setSortAsc, setSortField, setFilters} = productsActions;
